...
namespace VideoConverter
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            // 针对文件建立与之适应显示表头 
            listView1.Columns.Add("文件名", 140, HorizontalAlignment.Right);
            listView1.Columns.Add("文件地址", 315, HorizontalAlignment.Left);
            listView1.Columns.Add("文件大小", 70, HorizontalAlignment.Left);
            listView1.Columns.Add("状态", 59, HorizontalAlignment.Left);
        ...
        public void VideoConverter()
        {
            ...
            for (int i = 0; i < lv.Items.Count; i++)
            {
                if (lv.Items[i].SubItems[3].Text != "已完成")
                {
                    ...
                    //p.StartInfo.FileName = path + "ffmpeg.exe";, m
                    ...
                    newFileName = "\"" + label3.Text + "\\" + newFileName + DateTime.Now.ToString("yyyyMMddhhmmss") + ".mp4";
        ...
        /// <param name="e"></param>
        private void frmFileDisposal_Closed(object sender, FormClosedEventArgs e)
        {
